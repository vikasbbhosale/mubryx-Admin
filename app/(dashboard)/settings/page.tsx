      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="text-xl font-bold tracking-tight text-white">System Diagnostics & Platform Settings</h1>
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-lg p-4 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-lg bg-blue-600/20 border border-blue-500/30 text-blue-400 flex items-center justify-center font-bold text-base font-mono">
              {adminUser?.name?.charAt(0) || 'A'}
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-sm font-bold text-white">{adminUser?.name || 'Authorized Operator'}</h2>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-rose-400 hover:bg-rose-500/10 rounded border border-rose-500/30 transition-colors cursor-pointer self-start sm:self-auto"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          <div className="bg-slate-950 border border-slate-800 p-2.5 rounded">
            <div className="text-slate-500 font-medium uppercase text-[10px]">Session Token ID</div>
            <div className="font-mono text-slate-300 mt-0.5 truncate text-[11px]">{adminUser?.id}</div>
          </div>
          <div className="bg-slate-950 border border-slate-800 p-2.5 rounded">
            <div className="text-slate-500 font-medium uppercase text-[10px]">Authorization Status</div>
          ...
          <div className="bg-slate-950 border border-slate-800 p-2.5 rounded">
            <div className="text-slate-500 font-medium uppercase text-[10px]">Provisioned On</div>
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-lg p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="bg-slate-950 border border-slate-800 p-3 rounded space-y-1">
            <div className="font-semibold text-slate-200">HttpOnly Session Integrity</div>
          ...
          <div className="bg-slate-950 border border-slate-800 p-3 rounded space-y-1">
            <div className="font-semibold text-slate-200">Edge Proxy Interception</div>
            <p className="text-slate-400 text-[11px] leading-relaxed">
              Turbopack <code className="text-blue-400 font-mono">proxy.ts</code> routing forwards requests directly to NestJS gateway on port 3000 with zero client exposure.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-lg p-4 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded text-xs font-semibold border border-slate-700 transition-colors cursor-pointer"
          >
        ...
        <div className="divide-y divide-slate-800/80 border border-slate-800 rounded overflow-hidden text-xs">
          {/* Mubryx Server NestJS Gateway */}
          <div className="p-3 flex items-center justify-between bg-slate-950/60">
            <div className="flex items-center gap-2.5">
              <Database className="w-4 h-4 text-slate-400" />
              <div>
                <div className="font-semibold text-white">Mubryx Server & PostgreSQL Gateway</div>
                <div className="text-[10px] text-slate-500 font-mono">NestJS API Core • Prisma ORM Pool</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              {dbLatencyMs !== null && (
                <span className="font-mono text-[11px] text-slate-400">{dbLatencyMs}ms</span>
              )}
          ...
          <div className="p-3 flex items-center justify-between bg-slate-950/60">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="font-semibold text-white">Mubryx Admin Frontend Runtime</div>
